...
const Add = () => {
  ...
  return (
    ...
    <h1 style={{fontFamily:"monospace"}} className='text-success  text-center m-5 fw-bolder'>EMPLOYEE DETAILS</h1>
    <div className='d-flex justify-content-center p-2 m-3'>
        <button  onClick={handleShow} className='btn btn-danger fw-bolder'>Add New Employee</button>
    </div>
    </>
  )
}
